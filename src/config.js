const config = {
	...
	metaData: {
		title: 'AIKaid的观光车',
		description: '欢迎来到AIKaid的观光列车！',
		keywords: 'AIKaid,AIKaid,个人主页,个人网站',
	...
	background: {
		"pc": {   //pc端
			...
			"datainfo": {
				...
				"url": "https://s21.ax1x.com/2025/07/23/pVGlfIJ.jpg",     //当然，也可填写网络地址或壁纸api，如随机PC壁纸api："url":"https://t.mwm.moe/pc"
			},
		},
		"mobile": {   //移动端
			"type": "pic",
	...
	//极坐标图数据
	polarChart: {
		skills: ['AI', 'HTML', 'Supbase'],
		skillPoints: [60,45,20],
	},
